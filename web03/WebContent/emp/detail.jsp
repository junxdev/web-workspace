		...
		<tr>
			...
			<h1>EMP DETAIL</h1>
				<table border="0" width="600" cellspacing="1">
					...
					String sql = "SELECT a.empno, a.ename, a.job, NVL((SELECT b.ename FROM emp b WHERE a.mgr = b.empno), '-'), a.hiredate, a.sal, a.comm,";
					...
					try{
						...
						while(rs.next()) {
								...
								<tr align="center">
									...
									<td><%= java.text.NumberFormat.getInstance().format(rs.getInt(6)) %></td>
								</tr>
								<tr align="center">
									<td bgcolor="#aaaaaa">COMM</td>
									<td><%= java.text.NumberFormat.getInstance().format(rs.getInt(7)) %></td>
								</tr>
								<tr align="center">
								...
								<tr align="center">
									<td colspan="2">
										<a href="edit.jsp?empno=<%= rs.getInt(1) %>">[Edit]</a>
										<a href="delete.jsp?empno=<%= rs.getInt(1) %>">[Delete]</a>
									</td>
								</tr>
								<%
						}
