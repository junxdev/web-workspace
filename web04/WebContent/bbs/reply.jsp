		...
		<tr>
			<td colspan="6">
				<center>
					...
					<h1><%= request.getParameter("ref") %>번 글에 답글쓰기</h1>
					<form action="new_reply_insert.jsp" method="post">
						...
						<input type="hidden" name="reply_lv" value=<%= request.getParameter("reply_lv") %>>
